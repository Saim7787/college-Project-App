...
interface SliderProps {
  navigation: any; // or NavigationProp type based on your navigation setup
}

const Slider: React.FC<SliderProps> = ({ navigation }) => {
  ...
  const renderItem: React.FC<{ item: any }> = ({ item, index }) => {
