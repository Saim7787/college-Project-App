...
interface FeeStructerProps {
    ...
    } | undefined; // You can adjust this based on your actual data structure
  }
  const FeeStructer: React.FC<FeeStructerProps> = ({ selectedProgram }) => {
